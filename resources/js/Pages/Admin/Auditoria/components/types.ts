...
export interface UsuarioAuditoria { id: number; name: string; email?: string | null; roles?: string[]; }
export interface EventoAuditoria { evento?: string|null; descripcion?: string|null; fecha?: string|null; usuario?: UsuarioAuditoria|null; }
export interface PacienteAuditoria {
    ...
    auditoria_creacion?: EventoAuditoria|null; auditoria_actualizacion?: EventoAuditoria|null;
}
