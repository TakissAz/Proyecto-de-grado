...
export interface CatalogoReceta { id_receta:number; nombre:string; tipo_comida:string; porciones:number; preparacion?:string|null; calorias_totales:number|string; proteinas_totales:number|string; carbohidratos_totales:number|string; grasas_totales:number|string; fibra_total:number|string; receta_alimentos?:IngredienteRecetaPlan[] }
