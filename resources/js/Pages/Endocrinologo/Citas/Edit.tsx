...
export default function EditarCita({ cita, pacientes, profesional, tipoProfesional }: Props) {
    return (
        <AuthenticatedLayout title="Editar cita">
            <Head title="Editar cita - Endocrinólogo" />
            <div className="space-y-4">
                <Link href="/endocrinologo/citas" className="flex items-center gap-1 text-[11px] font-semibold text-ink-muted hover:text-ink transition-colors dark:text-ink-muted-dark dark:hover:text-ink-dark">
                ...
                <div className="card-elevated p-5">
                    ...
                    <CitaFormulario
                        ...
                        rutaStore={`/endocrinologo/citas/${cita.id_cita}`}
                        rutaBloques="/endocrinologo/citas/bloques"
                        inicial={cita}
                        metodo="put"
                    />
                </div>
