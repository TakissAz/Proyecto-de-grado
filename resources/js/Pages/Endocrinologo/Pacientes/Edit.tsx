...
export default function Edit({ paciente, flash }: Props) {
    ...
    const handleSubmit = (event: React.FormEvent) => {
        ...
        // PUT/PATCH via POST + _method para compatibilidad
        post(`/endocrinologo/pacientes/${paciente.id_paciente}?_method=PUT`, {
            preserveScroll: true,
        });
    };
                    ...
                    <Stack spacing={3}>
                        ...
                        <Box component="form" onSubmit={handleSubmit}>
                            ...
                            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end', mt: 3, flexWrap: 'wrap' }}>
                                <Button
                                    component={Link}
                                    href={`/endocrinologo/pacientes/${paciente.id_paciente}`}
                                    variant="outlined"
