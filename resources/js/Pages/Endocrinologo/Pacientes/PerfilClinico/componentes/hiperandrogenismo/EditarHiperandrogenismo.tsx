...
interface Props {
    abierto: boolean;
    idPaciente: number;
    hiperandrogenismo: HiperandrogenismoData;
    onCerrar: () => void;
}
            ...
            <div className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-2xl border border-surface-border bg-surface-card shadow-2xl dark:border-surface-border-dark dark:bg-surface-card-dark">
                ...
                <div className="sticky top-0 z-10 flex items-center justify-between rounded-t-2xl border-b border-surface-border bg-surface-card px-6 py-4 dark:border-surface-border-dark dark:bg-surface-card-dark">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-[16px] font-bold text-ink dark:text-ink-dark">Editar hiperandrogenismo</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                            ...
                            <InputField label="Grado de acné">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                            ...
                            <InputField label="Zonas afectadas">
                        ...
                        <div>
                            <InputField label="Puntaje Ferriman-Gallwey">
                                    ...
                                    <div className="flex items-start gap-3 mb-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-[10px] text-ink-muted dark:text-ink-muted-dark mt-0.5 leading-relaxed">
                                                9 zonas corporales, cada una puntuada de 0 a 4.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <p className="text-[9.5px] text-ink-muted/60 dark:text-ink-muted-dark/60 mt-1">≥ 8 = positivo para hirsutismo</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <InputField label="Inicio de síntomas">
